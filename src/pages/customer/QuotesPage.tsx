...
export function QuotesPage(){
 ...
 <div><p className="font-bold text-[#E30613]">{q.quote_number}</p><p className="text-white">{q.title}</p><p className="text-xs text-gray-500">{q.valid_until?'Válido até '+new Date(q.valid_until+'T12:00').toLocaleDateString('pt-BR'):'Sem prazo definido'}</p></div>
